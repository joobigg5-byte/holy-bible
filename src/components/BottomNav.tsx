...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-sacred-black border-t border-gold-dark/40">
      <div className="max-w-2xl mx-auto flex justify-around py-2">
        ...
        <button
          ...
          className="flex flex-col items-center gap-0.5 text-gold-muted/60 hover:text-gold-bright"
        >
          <Library size={18} />
